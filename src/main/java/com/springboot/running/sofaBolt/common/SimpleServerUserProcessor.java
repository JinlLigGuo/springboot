 ...
 */
package com.springboot.running.sofaBolt.common;
...
import com.springboot.running.sofaBolt.SofaBoltGlobal;
import com.springboot.running.sofaBolt.common.BoltServer;
import com.springboot.running.sofaBolt.common.RequestBody;
...
*/
    ...
    public Object handleRequest(BizContext bizCtx, RequestBody request) throws Exception {
        ...
        //String clientres = (String) server.getRpcServer().invokeSync(SofaBoltGlobal.connections.get(0), req, 1000);
