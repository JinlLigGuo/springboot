package com.springboot.running.mina.core;
...
public class CommandFactory {
    ...
    private static String CMD_BASE_PACKAGE = "com.springboot.running.mina.cmd.";
    private static String BIZ_BASE_PACKAGE = "com.springboot.running.mina.biz.";
